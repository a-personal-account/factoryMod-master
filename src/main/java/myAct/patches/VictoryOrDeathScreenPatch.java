...
public class VictoryOrDeathScreenPatch {
    ...
    public static class VictoryScreenPatch {
        ...
        public static void Insert(VictoryScreen __instance) {
            if (CardCrawlGame.dungeon instanceof Exordium || CardCrawlGame.dungeon instanceof TheCity || CardCrawlGame.dungeon instanceof TheBeyond || (CardCrawlGame.dungeon instanceof TheEnding && !MyAct.wentToTheFactory)) {
                return;
            }
            ...
            if (CardCrawlGame.dungeon instanceof Factory || MyAct.wentToTheFactory) {
                try {
                    String localizedString = CardCrawlGame.languagePack.getScoreString(MyAct.makeID("ElitesKilled")).NAME;
