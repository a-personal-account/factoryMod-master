    ...
    public void receivePostInitialize() {
        ...
        */
        ...
        BaseMod.addMonster(FactoryEncounterIDList.SMALL_MINIBOT_GANG_ENCOUNTER_ID, "4 Mini-Bots", () -> new MonsterGroup(
                ...
                }), Factory.ID, EnemyData.MonsterType.WEAK);
        ...
        BaseMod.addMonster(FactoryEncounterIDList.BIG_BOT_ENCOUNTER_ID, () -> new BigBot(10.0F, 0.0F), Factory.ID, EnemyData.MonsterType.WEAK);
        ...
        BaseMod.addMonster(FactoryEncounterIDList.LARGE_MINIBOT_HORDE_ENCOUNTER_ID, "6 Mini-Bots", () -> new MonsterGroup(
                ...
                }), Factory.ID, EnemyData.MonsterType.STRONG);
        ...
        BaseMod.addMonster(FactoryEncounterIDList.DEFECTIVE_SENTRY_ENCOUNTER_ID, () -> new DefectiveSentry(0.0F, 0.0F), Factory.ID, EnemyData.MonsterType.STRONG);
        ...
        // Elite Pool
        BaseMod.addMonster(FactoryEncounterIDList.MANSERVANTES_ENCOUNTER_ID, () -> new Manservantes(0.0F, 0.0F), Factory.ID, EnemyData.MonsterType.ELITE);
        BaseMod.addMonster(FactoryEncounterIDList.SMOG_ELEMENTAL_ENCOUNTER_ID, () -> new SmogElemental(-50.0F, 75.0F), Factory.ID, EnemyData.MonsterType.ELITE);
        BaseMod.addMonster(FactoryEncounterIDList.DRINK_BREWER_ENCOUNTER_ID, () -> new DrinkBrewer(0.0F, 0.0F), Factory.ID, EnemyData.MonsterType.ELITE);

        // Add bosses here
        BaseMod.addBoss(Factory.ID, Guardian2.ID, () -> new Guardian2(0.0F, 0.0F), "superResources/images/map/placeholder.png", "superResources/images/map/placeholderOutline.png");
        BaseMod.addBoss(Factory.ID, SPIDER.ID, () -> new SPIDER(0.0F, 100.0F), "superResources/images/map/placeholder.png", "superResources/images/map/placeholderOutline.png"); // A R T
        BaseMod.addBoss(Factory.ID, Experiment01.ID, () -> new Experiment01(0.0F, 0.0F), "superResources/images/map/placeholder.png", "superResources/images/map/placeholderOutline.png");

        // Add intents
        MyAct.addIntent(new SummonMiniBotIntent());

        // Add dungeon
        BaseMod.addAct(TheBeyond.ID, new Factory());
    }
